 ...
 *
 * Lifted out of the page because two screens now render it — the deck at
 * /dashboard and the dense wall at /wall — and because Next refuses any
 * export from a page file beyond its own small allowed set, so a loader
 * cannot live there and be shared.
 */
import type {
  EventRow, LogRow, Stats, TaskRow, WeatherRow,
